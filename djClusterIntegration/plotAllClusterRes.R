...
cluster1Expresssion = read_tsv('/Users/johnjamescolgan/Library/CloudStorage/Box-Box/b. breve/B. breve RNA seq/2025RnaAnalysis/DeSeq2/barseqjejunumOutputs/jejunumKmeansResults/cluster1SigGenes.tsv')
cluster2Expresssion = read_tsv('/Users/johnjamescolgan/Library/CloudStorage/Box-Box/b. breve/B. breve RNA seq/2025RnaAnalysis/DeSeq2/barseqjejunumOutputs/jejunumKmeansResults/cluster2SigGenes.tsv')
cluster3Expresssion = read_tsv('/Users/johnjamescolgan/Library/CloudStorage/Box-Box/b. breve/B. breve RNA seq/2025RnaAnalysis/DeSeq2/barseqjejunumOutputs/jejunumKmeansResults/cluster3SigGenes.tsv')
...
annotatedDistinctMutants%>%
  ...
  xlim(0,50)+
  labs(title = 'Mutant functions and relationship with each cluster',
       y = 'BRITE level 1',
       fill = 'BRITE level 2')